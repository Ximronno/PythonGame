...
resume_button = button.Button(400, 150, resume_img, 1)
quit_button = button.Button(430, 355, quit_img, 1)
...
def menu():
    is_menu_open = True
    global run, screen, game_paused, menu_state
    while is_menu_open:
...
bg_image = pygame.image.load("bckgrnd1.png").convert_alpha()
